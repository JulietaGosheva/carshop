...
<div class="container">
    <form id="form-reg" class="form-horizontal" action="registrationPHP.php" method="POST">
        <div class="form-group">
            ...
            <label id="name-error-label" style="color: red;" class="col-sm-offset-2 col-sm-5 control-label"></label>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="password" name="reppass" class="form-control" id="passrep-reg" placeholder="Повтори парола...">
            </div>
        </div>
        <div class="form-group">
